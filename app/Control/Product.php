                ...
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="../../Model/user/DeleteProduct.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">Eliminar</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
