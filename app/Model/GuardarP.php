...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($connect->query($sql) === TRUE) {
        ...
        echo "<script>alert('Producto registrado correctamente'); window.location.href = '../Views/formulario.php';</script>";
    } else {
        echo "<script>alert('Error al registrar el producto'); window.location.href = '../Views/formulario.php';</script>";
    }
